...
CApp::CApp(SAppInfo appInfo) : m_appInfo(appInfo)
{
    ...
    m_vecGameObjects.emplace_back(std::make_unique<CModel>(("../assets/models/viking_room.obj")));
    m_vecGameObjects.emplace_back(std::make_unique<CModel>(("../assets/models/cube.obj"), glm::vec3(0.0f, 5.0f, 0.0f)));
